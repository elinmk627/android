package com.example.topc_3.dialogtest;
...
//    });
    ...
    // case2 : 지역변수를 멤버변수로 승급
    // 메소드 밖에서 AlertDialog alertDialog;선언
    ...
    // 콜백함수(setOnClickListener) 안에서 사용하는 참조와 다르게 되어 버그가 발생할수 있게되므로
    // 자바는 원천적으로 이런 변수 앞에 final 키워드를 붙여서 변수의 조작을 불허함.
